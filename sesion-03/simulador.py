...
# print(objFaker.random_int(min=1, max=100))

# objFaker = Faker()
# alumnos = [(10, 1), (86, 3), (55, 4), (32, 1), (10, 2), (1, 3)]
# for i in range(200):
#     alumno = objFaker.random_int(
#         min=1, max=100), objFaker.random_int(min=1, max=4)
#     alumnos.append(alumno)
# # print(alumnos)


# repetidos = []
# alunnos_no_repetidos = []
# for n in alumnos:
#     if n not in alunnos_no_repetidos:
#         alunnos_no_repetidos.append(n)
#     else:
#         repetidos.append(n)
# print("repetidos")
# # print(alunnos_no_repetidos)
# for i in alunnos_no_repetidos:
#     print(
#         f'INSERT INTO ALUMNOS_CURSOS (ALUMNO_ID, CURSO_ID) VALUES({i[0]},{i[1]});')

data = [[1, 3], [10, 2], [32, 1], [55, 4], [86, 3], [10, 1]]
x = 0
while x < 200:
    curso = objFaker.random_int(min=1, max=4)
    alumno = objFaker.random_int(min=1, max=99)
